...
public partial class jsonBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IjsonVisitor<Result> {
	/// <summary>
	/// Visit a parse tree produced by <see cref="jsonParser.compileUnit"/>.
	/// <para>
	...
	public virtual Result VisitCompileUnit([NotNull] jsonParser.CompileUnitContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="jsonParser.objectProperty"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitObjectProperty([NotNull] jsonParser.ObjectPropertyContext context) { return VisitChildren(context); }
	/// <summary>
